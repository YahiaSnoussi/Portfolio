...
- [ ] **Production prep (next)**: env-var secrets + rotate committed `jwt.secret`, prod environment/remove hardcoded localhost, Docker Compose + Caddy on a VPS, backups, change seeded admin, legal pages. Yahia has no VPS/domain yet.
